...
scaler_type = ScalerType.ZSCORE.value
...
# exclude batteries
exclude_batteries = ["B0049", "B0050", "B0051", "B0052", "B0025", "B0026","B0027","B0028"]
# exclude_batteries = []
...
class TrainParams:
    ...
    lr: float = field(default_factory=get_train_lr)
