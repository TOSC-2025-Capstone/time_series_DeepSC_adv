...
data = {
    'SNR': [5, 5, 5, 5, 10, 10, 10, 10, 15, 15, 15, 15],
    'Model': [
        'LSTM', 'GRU', 'Transformer', 'Inverted-Transformer',
        'LSTM', 'GRU', 'Transformer', 'Inverted-Transformer',
        'LSTM', 'GRU', 'Transformer', 'Inverted-Transformer'
    ],
    'MSE': [
        5.362872, 6.346788, 12.405866, 2.562294,
        1.746104, 2.136873, 2.588712, 0.930088,
        0.579162, 0.696572, 0.682000, 0.502369
    ]
}
...
plt.savefig('case39_mse_comparison_grayscale.png', dpi=300)
print("Graph saved as 'case39_mse_comparison_grayscale.png' with grayscale contrast.")
