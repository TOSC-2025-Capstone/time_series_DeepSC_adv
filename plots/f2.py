...
def plot_feature_comparison(
    ...
    for i, feature in enumerate(feature_names):
        ...
        plt.plot(df_deepsc[feature], label="10044_iT", **plot_styles["DeepSC"] )
        plt.plot(df_lstm[feature], label="10043_iT", **plot_styles["LSTM"] )
...
if __name__ == "__main__":
    ...
    csv_paths = [
        ...
        "results/performance_test/case10044.1.2/AWGN_deepsc_MSE/performance_statistics.csv",
        "results/performance_test/case10044.1.5/AWGN_deepsc_MSE/performance_statistics.csv",
        "results/performance_test/case10044.1.8/AWGN_deepsc_MSE/performance_statistics.csv",
    ]
    ...
    metric_type = "MSE"
    case_index_prefix = "10044"
    date = "251128"  # 그래프 저장용 날짜 디렉토리 이름
    save_path_prefix = f"./final_comparison_plots/{date}"
    save_path = save_path_prefix + (
        f"/stats/case{case_index_prefix}/{metric_type}/{filename}/segment_16/case_46(lstm)_10044_comp"
    )
    ...
    case_labels = ["46_lstm-snr 3", "46_lstm-snr 12",  "46_lstm-snr 21", "10044_iT-snr 3", "10044_iT-snr 12",  "10044_iT-snr 21",]
    ...
    #             lstm_path=f"./reconstruction/case{str(int(case_index_prefix)-1)}.1.{snr_db_index+1}/reconstructed_AWGN_deepsc_MSE",
    ...
    #                 "Time",
    #             ],
    #             save_path=save_path_prefix + f"/final_comparision/case{case_index_prefix}/{filename}/{snr_db_list[snr_db_index]}/43_iT_44_iTcomp",
    #             # filename="01420.csv",
    #             filename=filename,
    #         )
