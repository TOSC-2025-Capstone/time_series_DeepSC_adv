...
if __name__ == "__main__":
    ...
    test = model_params["snr_db"]
    test2 = model_params["num_layers"]

    print(f"========================== case_{p.case_index} start ==========================\n")
    print(f"snr: {test}, caseindex: {p.case_index}, batch_size={p.train_batch_size}, test_path={test_model_checkpoint_path}, num_layers={test2} 으로 설정되었습니다.")
