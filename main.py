...
if __name__ == "__main__":
    ...
    for seq_len_idx, v_seq_len in enumerate(seq_len_list):
        ...
        test1 = model_params['max_len']
        test2 = model_params["compressed_len"]

        print(f"========================== case_{p.case_index} start ==========================\n")
        print(f"max_len={test1}, compressed_len={test2}, caseindex: {p.case_index}, batch_size={p.train_batch_size}, test_path={test_model_checkpoint_path}, num_layers={test2} 으로 설정되었습니다.")
